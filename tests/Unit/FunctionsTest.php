...
{
    #[Test]
    public function it_documents_floor_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_ceiling_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_string_length_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_int_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_number_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_string_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_contains_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_starts_with_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_normalize_space_function_behavior()
    {
        $this->assertSame('abacate verde', (new NormalizeSpaceFunction('   abacate   verde  '))->handle());
    }

    #[Test]
    public function it_documents_choose_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_not_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_true_function_behavior()
    {
        $this->assertTrue((new TrueFunction())->handle());
    }

    #[Test]
    public function it_documents_false_function_behavior()
    {
        $this->assertFalse((new FalseFunction())->handle());
    }

    #[Test]
    public function it_documents_selected_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_substring_after_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_substring_before_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_format_date_time_function_behavior()
    {
    ...
    #[Test]
    public function it_documents_uuid_function_behavior()
    {
